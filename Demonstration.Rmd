...
For this tutorial, you can download '**NeutraliseFiles_tutorial.zip**' from '<https://github.com/lucp9827/NeutraliseFiles>'. Unzip the '**NeutraliseFiles_tutorial**' file and save the path to this unzipped folder.
