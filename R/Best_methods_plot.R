#' @export
Best_method_plot = function(path,name_extra,n=20,alpha=0.05,name_methods=NULL){
  ...
  results_df = filter_type1(path,results,results_power=results_list,alpha)$filter_df
